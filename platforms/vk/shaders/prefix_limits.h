...
#define RS_SWEEP_0_SIZE    (RS_WORKGROUP_SUBGROUPS > 1 ? RS_RADIX_SIZE   / RS_SUBGROUP_SIZE : 0)
#define RS_SWEEP_1_SIZE    (RS_WORKGROUP_SUBGROUPS > 1 ? RS_SWEEP_0_SIZE / RS_SUBGROUP_SIZE : 0)
#define RS_SWEEP_2_SIZE    (RS_WORKGROUP_SUBGROUPS > 1 ? RS_SWEEP_1_SIZE / RS_SUBGROUP_SIZE : 0)
