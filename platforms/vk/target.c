  ...
  if (subgroup_props)
    {
      ...
      target.config.init.workgroup_size_log2 = MAX_MACRO(uint32_t, target.config.init.workgroup_size_log2, subgroup_log2);
      target.config.fill.workgroup_size_log2 = MAX_MACRO(uint32_t, target.config.fill.workgroup_size_log2, subgroup_log2);
      target.config.histogram.workgroup_size_log2 = MAX_MACRO(uint32_t, target.config.histogram.workgroup_size_log2, subgroup_log2);
      target.config.prefix.workgroup_size_log2 = MAX_MACRO(uint32_t, target.config.prefix.workgroup_size_log2, subgroup_log2);
      target.config.scatter.workgroup_size_log2 = MAX_MACRO(uint32_t, target.config.scatter.workgroup_size_log2, subgroup_log2);
    }
  return target;
}
...
const struct radix_sort_vk_target_modules radix_sort_u32_modules_i64 = {
  .module_count = 6,
  .module_size = {
    sizeof(i64_u32_init_comp_shader_binary),
  ...
  .module_data = {
    i64_u32_init_comp_shader_binary,
...
const struct radix_sort_vk_target_modules radix_sort_u64_modules_i64 = {
  .module_count = 8,
  .module_size = {
    sizeof(i64_u64_init_comp_shader_binary),
  ...
  .module_data = {
    i64_u64_init_comp_shader_binary,
...
const struct radix_sort_vk_target_modules radix_sort_u32_modules_noi64 = {
  .module_count = 6,
  .module_size = {
    sizeof(noi64_u32_init_comp_shader_binary),
  ...
  .module_data = {
    noi64_u32_init_comp_shader_binary,
...
const struct radix_sort_vk_target_modules radix_sort_u64_modules_noi64 = {
  .module_count = 8,
  .module_size = {
    sizeof(noi64_u64_init_comp_shader_binary),
  ...
  .module_data = {
    noi64_u64_init_comp_shader_binary,
